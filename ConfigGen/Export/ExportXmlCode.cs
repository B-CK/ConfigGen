...
namespace ConfigGen.Export
{
    public class ExportXmlCode
    {
        ...
        private static readonly List<string> XmlNameSpaces = new List<string>() { "System", "System.Linq", "System.IO", Setting.XmlRootNode + Setting.ConfigRootNode, "System.Xml", "System.Collections.Generic" };
        ...
        private static void DefineXmlObject()
        {
            ...
            builder.AppendLine();
            builder.NameSpace(Setting.XmlRootNode + Setting.ConfigRootNode);
        ...
        private static void GenXmlClass()
        {
            ...
            while (cit.MoveNext())
            {
                ...
                builder.UsingNamespace(XmlNameSpaces);
                builder.AppendLine();
                builder.NameSpace(Setting.XmlRootNode + cls.Namespace);
        ...
        {
            if (fullType.StartsWith(Setting.ConfigRootNode))
                return Setting.XmlRootNode + fullType;
            return fullType;
        }
        private static void GenXmlEnums()
        {
            ...
            for (int i = 0; i < exports.Count; i++)
            {
                ...
                builder.NameSpace(Setting.XmlRootNode + en.Namespace);
                ...
                builder.EndAll();
                string path = string.Format("{0}{1}{2}.{3}.cs", Setting.XmlCodeDir, Setting.XmlRootNode, en.Namespace, en.Name);
                Util.SaveFile(path, builder.ToString());
                builder.Clear();
            }
        }
