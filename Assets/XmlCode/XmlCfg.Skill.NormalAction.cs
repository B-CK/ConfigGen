...
namespace XmlCfg.Skill
{
	public  class NormalAction : XmlObject
	{
		...
		/// 动作来源
		/// <summary>
		public XmlCfg.Skill.ActionSourceType ActionSource;
		/// <summary>
		/// 其他模型名称,用于套用其他模型动作
		/// <summary>
		...
		public override void Read(XmlNode _1)
		{
			...
			switch (_2.Name)
			{
				...
				case "ActionSource": this.ActionSource = (XmlCfg.Skill.ActionSourceType)ReadInt(_2); break;
				...
				case "Actions": GetChilds(_2).ForEach (_3 => this.Actions.Add(ReadObject<XmlCfg.Skill.Action>(_3, "XmlCfg.Skill.Action"))); break;
				case "Effects": GetChilds(_2).ForEach (_3 => this.Effects.Add(ReadObject<XmlCfg.Skill.EffectGroup>(_3, "XmlCfg.Skill.EffectGroup"))); break;
			}
		}
	}
}
