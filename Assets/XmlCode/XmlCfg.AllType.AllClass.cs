	...
	public  class AllClass : XmlObject
	{
		...
		public override void Read(XmlNode _1)
		{
			...
			switch (_2.Name)
			{
				...
				case "VarDictClass": GetChilds(_2).ForEach (_3 => this.VarDictClass.Add(ReadString(GetOnlyChild(_3, "Key")), ReadObject<XmlCfg.AllType.SingleClass>(_3, "XmlCfg.AllType.SingleClass"))); break;
			}
		}
	}
}
