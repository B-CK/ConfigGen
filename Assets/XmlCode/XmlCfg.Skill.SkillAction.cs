...
namespace XmlCfg.Skill
{
	public  class SkillAction : XmlObject
	{
		...
		/// 施放相对位置(1 自己 ,2目标)
		/// <summary>
		public XmlCfg.Skill.SkillRelateType RelateType;
		/// <summary>
		/// 打击点组列表
		/// <summary>
		...
		public override void Read(XmlNode _1)
		{
			...
			switch (_2.Name)
			{
				...
				case "RelateType": this.RelateType = (XmlCfg.Skill.SkillRelateType)ReadInt(_2); break;
				case "HitPoints": GetChilds(_2).ForEach (_3 => this.HitPoints.Add(ReadObject<XmlCfg.Skill.HitPointGroup>(_3, "XmlCfg.Skill.HitPointGroup"))); break;
				case "HitZones": GetChilds(_2).ForEach (_3 => this.HitZones.Add(ReadObject<XmlCfg.Skill.HitZone>(_3, "XmlCfg.Skill.HitZone"))); break;
				case "BeAttackEffects": GetChilds(_2).ForEach (_3 => this.BeAttackEffects.Add(ReadObject<XmlCfg.Skill.BeAttackEffect>(_3, "XmlCfg.Skill.BeAttackEffect"))); break;
			}
		}
	}
}
