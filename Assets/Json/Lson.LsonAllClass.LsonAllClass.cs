...
namespace Lson.LsonAllClass
{
	public class LsonAllClass : LsonObject
	{
		...
		/// 类类型
		/// <summary>
		public Lson.LsonAllClass.LSingleClass VarClass;
		/// <summary>
		/// 字符串列表
		/// <summary>
		...
		/// Class列表
		/// <summary>
		public List<Lson.LsonAllClass.LSingleClass> VarListClass;
		/// <summary>
		/// Elem列表
		/// <summary>
		...
		/// 类类型字典
		/// <summary>
		public Dictionary<string, Lson.LsonAllClass.LSingleClass> VarDictClass;
	}
}
