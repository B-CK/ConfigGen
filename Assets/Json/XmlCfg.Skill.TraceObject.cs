...
{
	public  class TraceObject : XmlCfg.Skill.SpawnObject
	{
		/// <summary>
		/// 身体矫正值
		/// <summary>
		...
		/// 追踪类型
		/// <summary>
		public XmlCfg.Skill.TraceType TraceType;
		/// <summary>
		/// 释放者绑定位置
		/// <summary>
		public XmlCfg.Skill.TraceBindType CasterBindType;
		/// <summary>
		/// 被击者绑定位置
		/// <summary>
		public XmlCfg.Skill.TraceBindType TargetBindType;
		...
		public override void Read(XmlNode _1)
		{
			...
			switch (_2.Name)
			{
				...
				case "TraceType": this.TraceType = (XmlCfg.Skill.TraceType)ReadInt(_2); break;
				case "CasterBindType": this.CasterBindType = (XmlCfg.Skill.TraceBindType)ReadInt(_2); break;
				case "TargetBindType": this.TargetBindType = (XmlCfg.Skill.TraceBindType)ReadInt(_2); break;
			}
		}
	}
}
