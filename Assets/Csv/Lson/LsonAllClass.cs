...
namespace Csv.Lson
{
	public class LsonAllClass : CfgObject
	{
		...
		/// 类类型
		/// <summary>
		public Csv.Lson.LSingleClass VarClass;
		/// <summary>
		/// 字符串列表
		/// <summary>
		...
		/// Class列表
		/// <summary>
		public readonly List<Csv.Lson.LSingleClass> VarListClass = new List<Csv.Lson.LSingleClass>();
		/// <summary>
		/// Elem列表
		/// <summary>
		...
		/// 类类型字典
		/// <summary>
		public readonly Dictionary<string, Csv.Lson.LSingleClass> VarDictClass = new Dictionary<string, Csv.Lson.LSingleClass>();
		...
		public LsonAllClass(DataStream data)
		{
			...
			this.VarClass = new Lson.LSingleClass(data);
			...
			for (int n = data.GetInt(); n-- > 0; )
			{
				this.VarListClass.Add(new Lson.LSingleClass(data));
			}
			for (int n = data.GetInt(); n-- > 0; )
			{
			...
			for (int n = data.GetInt(); n-- > 0;)
			{
				...
				this.VarDictClass[k] = new Lson.LSingleClass(data);
			}
		}
	}
}
