...
namespace Export
{
    public class ExportXmlCode
    {
        ...
        private static readonly List<string> XmlNameSpaces = new List<string>() { "System", "System.Linq", "System.IO", Setting.XmlRootNode + Setting.ModuleName, "System.Xml", "System.Collections.Generic" };
        ...
        private static void DefineXmlObject()
        {
            ...
            builder.AppendLine();
            builder.NameSpace(Setting.XmlRootNode + Setting.ModuleName);
