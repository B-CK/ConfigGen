...
namespace Example
{
	...
	public class DataStream
	{
		...
		public Example.CfgObject GetObject(string name)
		{
			return (Example.CfgObject)Type.GetType(name).GetConstructor(new[] { typeof(Example.DataStream) }).Invoke(new object[] { this });
		}
	}
}
